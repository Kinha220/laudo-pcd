...
st.caption(f"CNPJ formatado: {cnpj}")

data_raw = st.text_input("Data")
data = formatar_data(data_raw)
st.caption(f"Data formatada: {data}")
...
cpf_requerente_raw = st.text_input("CPF")
cpf_requerente = formatar_cpf(cpf_requerente_raw)
st.caption(f"CPF formatado: {cpf_requerente}")
...
cpf_medico_raw = st.text_input("CPF do médico")
cpf_medico = formatar_cpf(cpf_medico_raw)
st.caption(f"CPF médico formatado: {cpf_medico}")

especialidade = st.text_input("Especialidade")

unidade = st.text_input("Unidade Emissora do Laudo", value=servico_medico)

cnpj_unidade_raw = st.text_input("CNPJ da Unidade", value=somente_numeros(cnpj))
cnpj_unidade = formatar_cnpj(cnpj_unidade_raw)
st.caption(f"CNPJ unidade formatado: {cnpj_unidade}")

responsavel_unidade = st.text_input("Responsável pela Unidade")

cpf_responsavel_unidade_raw = st.text_input("CPF do Responsável pela Unidade")
cpf_responsavel_unidade = formatar_cpf(cpf_responsavel_unidade_raw)
st.caption(f"CPF responsável formatado: {cpf_responsavel_unidade}")
